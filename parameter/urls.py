...
urlpatterns = [
    ...
    path('del_start_site', views.del_start_site, name='del_start_site'),
    ...
    path('del_end_site', views.del_end_site, name='del_end_site'),
    ...
    path('del_vehicle', views.del_vehicle, name='del_vehicle'),
    ...
    path('del_site2owner', views.del_site2owner, name='del_site2owner'),
